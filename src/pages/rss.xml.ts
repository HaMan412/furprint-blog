  ...
  const items = await Promise.all(
    sortedPosts.map(async (blog: any) => {
      ...
      return {
        ...
        content: `<blockquote>This rendering was automatically generated by Aeralis Feed and may have formatting issues. For the best experience, please visit: <a href="${postURL}">${postURL}</a></blockquote> ${content}`,
        customData: `
